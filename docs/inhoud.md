...
3. [Bit en Boolean – de kleinste eenheid](bit_boolean.md)
4. [Output – dingen aansturen](output.md)
5. [Input – dingen meten](input.md)
6. [GPIO – Input/Output in de praktijk](gpio.md)
